...
import numpy as np
arch_list = ['imec_shift_buffer', 'imec']
...
fig.suptitle('IMEC Latency and Energy Normalized to H100, with JSRAM or shift memory, iso-area')
fig.tight_layout()
plt.savefig("fig_ablation_JSRAM.pdf")
