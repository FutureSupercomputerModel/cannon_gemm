...
def exp_normalize_power():
    ...
    cmos3d_leaf = Leaf(pe_arr_dim=128.0*4, 
                        ...
                        mac_area=550,
                        is3d=True)
    cmos3d_blade = Arch(mesh_dim=6.0, 
...
# my_plot.plot_energy(energy_table, gemm_dims, "energy_normalize_power.pdf")
# my_plot.plot_latency(time_table, gemm_dims, "latency_normalize_power.pdf")