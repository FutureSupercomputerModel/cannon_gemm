...
my_plot.plot(time_table, gemm_dims, "latency", ax[0][0])
my_plot.plot(energy_table, gemm_dims, "energy", ax[1][0])

time_table, energy_table = exp_normalize_mac_count.exp_normalize_mac_count()
my_plot.plot(time_table, gemm_dims, "latency", ax[0][1])
my_plot.plot(energy_table, gemm_dims, "energy", ax[1][1])

time_table, energy_table = exp_normalize_area.exp_normalize_area()
my_plot.plot(time_table, gemm_dims, "latency", ax[0][2])
my_plot.plot(energy_table, gemm_dims, "energy", ax[1][2])

time_table, energy_table = exp_normalize_power.exp_normalize_power()
my_plot.plot(time_table, gemm_dims, "latency", ax[0][3])
my_plot.plot(energy_table, gemm_dims, "energy", ax[1][3])
...
fig.tight_layout()
plt.savefig("fig_latency_energy_normalize_mac_throughput.pdf")
