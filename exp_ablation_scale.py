...
import numpy as np
arch_list = ['1PFLOPs', '8PFLOPs', '80PFLOPs', '1000PFLOPs']
...
fig.suptitle('IMEC Latency and Energy Normalized to iso-area H100, at different scales')
fig.tight_layout()
plt.savefig("fig_ablation_scale.pdf")
