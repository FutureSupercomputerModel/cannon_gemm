...
import json
import my_plot
def exp_normalize_mac_throughput():
    ...
    cmos3d_leaf = Leaf(pe_arr_dim=128.0*4, 
                        ...
                        mac_area=550,
                        is3d=True)
    cmos3d_blade = Arch(mesh_dim=10.0, 
    ...
    cryoE_leaf = Leaf(pe_arr_dim=128.0*4, 
                        ...
                        mac_area=550,
                        is3d=True)
    cryoE_blade = Arch(mesh_dim=10.0, 
                    mesh_bw=f'{9680}GBps', 
                    buffer_size="80GB", 
                    buffer_bw='30.0TBps', 
                    mesh_E_per_bit='0.1pJ', 
